...
public class minipythonParser extends Parser {
	...
	public static final int
		...
		LTE=10, GTE=11, PLUS=12, MINUS=13, STAR=14, DIVIDE=15, INCREMENT=16, DECREMENT=17,
		NOT=18, SUPER=19, DOT=20, COMMA=21, COLON=22, L_PAREN=23, R_PAREN=24,
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"GT", "LTE", "GTE", "PLUS", "MINUS", "STAR", "DIVIDE", "INCREMENT", "DECREMENT",
			"NOT", "SUPER", "DOT", "COMMA", "COLON", "L_PAREN", "R_PAREN", "DEF",
			"CLASS", "WHILE", "IF", "ELIF", "ELSE", "RETURN", "END", "TRUE", "FALSE",
			"NAME", "STRING", "NUMBER"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 268948156416L) != 0) {
				{
				{
				setState(50);
				statement();
	...
	private UnaryContext unary(int _p) throws RecognitionException {
		...
		int _startState = 42;
		enterRecursionRule(_localctx, 42, RULE_unary, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			case NOT:
				...
				setState(191);
				_la = _input.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 274432L) != 0) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case L_PAREN:
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if (((_la) & ~0x3f) == 0 && ((1L << _la) & 266297356288L) != 0) {
							{
							setState(207);
							arguments();
							}
