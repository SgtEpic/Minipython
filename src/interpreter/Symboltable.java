...
public class Symboltable implements Expr.Visitor<Void>, Stmt.Visitor<Void>{
    ...
    Symboltable(Interpreter interpreter, Boolean printTables) {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        for (Stmt.Function method : stmt.methods) {
            ...
            if (method.symbol.lexeme.equals("init")) {
    ...
    public Void visitSuperExpr(Expr.Super expr) {
        if (currentClass == ClassType.NONE) {
            ...
            Minipython.error(expr.keyword, "Cannot use 'super' in a class with no superclass.");
        }
        resolveLocal(expr, expr.keyword);
        return null;
    }
