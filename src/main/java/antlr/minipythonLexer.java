...
public class minipythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WHITESPACE", "COMMENT", "ASSIGN", "ASSIGNPLUS", "ASSIGNMINUS", "ASSIGNSTAR",
			"ASSIGNDIVIDE", "OR", "AND", "EQ", "NEQ", "LT", "GT", "LTE", "GTE", "PLUS",
			"MINUS", "STAR", "DIVIDE", "INCREMENT", "DECREMENT", "NOT", "SUPER",
